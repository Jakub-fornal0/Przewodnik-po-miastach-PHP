...
<?php
      ...
      if ($userId == -1) {
                  ...
                  <div class="container px-5">
                      <div class="bg-light rounded-3 py-5 px-4 px-md-5 mb-5">
                          <div class="text-center mb-5">
                              <h1 class="fw-bolder">Twoje opinie:</h1>
                          </div>';
        echo $bd->select3 ("select Id,miasto,pozytywnie,negatywnie,ocena,komentarz from opinie WHERE userId='".$userId."'", ["Id","miasto","pozytywnie","negatywnie","ocena","komentarz"]);
        
        echo '</div><br /><br /><div class="bg-light rounded-3 py-5 px-4 px-md-5 mb-5">
                    <div class="text-center mb-5">
                        <h1 class="fw-bolder">Usuń opinie:</h1>
                    </div>
                    <form method="post" action="usunOpinie.php" >
                            <div class="form-floating mb-3">
                                          <input class="form-control" id="doUsu" name="doUsu" type="number" />
                                          <label for="doUsu">Podaj id opinii do usunięcia</label>
                                          <div class="text-center mb-5">
                                              <br /><input class="btn btn-outline-primary" type="submit" name="usunOp" id="usunOp" value="Usuń" />
                                          </div>
                          </div></form></div>';
        ...
        echo '<div class="text-center mb-5">
                <a href="glownyFormularz.php" class = navbar-brand" value="Powrót do formularza">Powrót</a></div></div></section>';
      }   
